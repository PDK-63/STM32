...
//  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_SET);
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	    ...
	    if (receivedData[0] == 1)//staight ahead
			{
	     ...
	     if (receivedData[0] == 2)//turn the right
			{
	     ...
	     if (receivedData[0] == 3)//turn the left
			{
	              HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_RESET);
